                            ...
                            with open('settings/commands.json', 'r+') as commands:
                                ...
                                try:
                                    ...
                                    await self.bot.edit_message(menu,
                                                                bot_prefix + 'Successfully added ``{}`` to ``{}`` Invoke this response by doing: ``{}``'.format(
                                    ...
                                    await self.bot.edit_message(menu,
                                                                bot_prefix + 'Error, something went wrong. Exception: ``%s``' % e)
                                    ...
                                    if reply:
                                        ...
                                        with open('settings/commands.json', 'r+') as commands:
                                            ...
                                            try:
                                                ...
                                                json.dump(cmds, commands, indent=4)
                                                await self.bot.edit_message(menu,
                                                                            bot_prefix + 'Successfully added response with response name ``{}`` to command ``{}`` Invoke this specific response with ``{}`` or get a random response from the list of responses for this command with ``{}``'.format(
                                                                                entry_response, entry_cmd,
                        ...
                        # Add to existing list cmd
                            ...
                            if count == 0:
                                return await self.bot.edit_message(menu,
                                                               bot_prefix + 'There are no cmds you can add multiple responses to. Create a cmd that enables multiple responses and then add a response to it.')
                            menu = await self.bot.edit_message(menu,
        ...
        if not msg:
            ...
            if reply:
                ...
                if reply.content == '1':
                    ...
                    if count == 0:
                        return await self.bot.edit_message(menu,
                                                           bot_prefix + 'There are no cmds to remove.')
                    menu = await self.bot.edit_message(menu,
                    ...
                    if reply:
                        ...
                        with open('settings/commands.json', 'r+') as commands:
                            ...
                            try:
                                ...
                                json.dump(cmds, commands, indent=4)
                                await self.bot.edit_message(menu,
                                                            bot_prefix + 'Successfully removed command ``{}``'.format(cmd_to_remove))
                            except Exception as e:
                ...
                # Remove a specific response from a cmd
                    ...
                    if count == 0:
                        return await self.bot.edit_message(menu,
                                                           bot_prefix + 'There are no cmds with multiple responses. If you are looking to remove a cmd with just one response, select 1 in the main menu for this command.')
                    menu = await self.bot.edit_message(menu,
                        ...
                        if reply:
                            ...
                            with open('settings/commands.json', 'r+') as commands:
                                ...
                                try:
                                    ...
                                    json.dump(cmds, commands, indent=4)
                                    await self.bot.edit_message(menu,
                                                                bot_prefix + 'Successfully removed response with name ``{}`` from command ``{}``'.format(
